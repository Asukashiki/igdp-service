...
public class RsaEncrypt {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //加密字符串
        String message = "admin1";
        System.out.println("随机生成的公钥为:" + publicKey);
        System.out.println("随机生成的私钥为:" + privateKey);
        String messageEn = encrypt(message, publicKey);
        System.out.println(message + "\t加密后的用户名为:" + messageEn);
        String passwordEn = encrypt(message, publicKey);
        System.out.println(message + "\t加密后的密码为:" + passwordEn);
