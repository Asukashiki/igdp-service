...
CREATE TABLE IF NOT EXISTS `c1_breeding_batch` (
    ...
    `audit_status` varchar(20) DEFAULT NULL COMMENT '审核状态：pending-待审核，approved-已通过，rejected-已驳回',
    `auditor` varchar(100) DEFAULT NULL COMMENT '审核人',
    `auditor_org_id` varchar(64) DEFAULT NULL COMMENT '审核人组织ID',
    `auditor_org_name` varchar(200) DEFAULT NULL COMMENT '审核人组织名称',
