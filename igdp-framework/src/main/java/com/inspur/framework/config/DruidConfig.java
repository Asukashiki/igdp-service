...
import com.inspur.framework.config.properties.DruidProperties;
import com.inspur.framework.datasource.DynamicDataSource;
...
public class DruidConfig
{
    ...
    @Bean
    @ConfigurationProperties("spring.datasource.druid.workflow")
    @ConditionalOnProperty(prefix = "spring.datasource.druid.workflow", name = "enabled", havingValue = "true")
    public DataSource istWorkflowDataSource(DruidProperties druidProperties)
    {
        DruidDataSource dataSource = DruidDataSourceBuilder.create().build();
        return druidProperties.dataSource(dataSource);
    }
    ...
    public DynamicDataSource dataSource(DataSource masterDataSource)
    {
        ...
        setDataSource(targetDataSources, DataSourceType.IST_WEB.name(), "istWebDataSource");
