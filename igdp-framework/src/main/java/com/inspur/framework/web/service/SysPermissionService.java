        ...
        else
        {
            ...
            if (!CollectionUtils.isEmpty(roles))
            {
                ...
                for (SysRole role : roles)
                {
                    ...
                    if(null != rolePerms && !rolePerms.isEmpty()){
            ...
            {
                Set<String> permsByUserId = menuService.selectMenuPermsByUserId(user.getUserId());
                if(null != permsByUserId && !permsByUserId.isEmpty()){
                    perms.addAll(permsByUserId);
                }
            }
        }
        return perms;
