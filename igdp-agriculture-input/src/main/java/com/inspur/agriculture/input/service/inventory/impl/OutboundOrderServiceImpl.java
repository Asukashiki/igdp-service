...
public class OutboundOrderServiceImpl implements IOutboundOrderService {
    ...
    public String createOutboundOrder(OutboundOrder outboundOrder, List<Map<String, Object>> details) {
        ...
        for (Map<String, Object> detail : details) {
            ...
            detailEntity.setSpecModel(detail.get("specModel") != null ? detail.get("spec_model").toString() : null);
    ...
    public Map<String, Object> confirmOutbound(String outboundOrderId, Date outboundTime, String operator) {
        ...
        for (OutboundOrderDetail detail : details) {
            ...
            for (Stock stock : availableStocks) {
                ...
                stock.setOutboundQuantity(stock.getOutboundQuantity().add(outboundQuantity));
                ...
                split.setInboundBatchId(stock.getMaterialBatchId());
                ...
                stockLog.setMaterialBatchId(stock.getMaterialBatchId());
                ...
                stockLog.setOperator(operator != null ? operator : outboundOrder.getOperator());
                ...
                stockInfo.put("batch_id", stock.getMaterialBatchId());
                stockInfo.put("outbound_quantity", outboundQuantity);
                stockInfo.put("remaining_quantity", afterQuantity);
                updatedStock.add(stockInfo);

                // 批次拆分信息
                Map<String, Object> splitInfo = new HashMap<>();
                splitInfo.put("inbound_batch_id", stock.getMaterialBatchId());
                splitInfo.put("split_quantity", outboundQuantity);
                splitInfo.put("remaining_quantity", afterQuantity);
