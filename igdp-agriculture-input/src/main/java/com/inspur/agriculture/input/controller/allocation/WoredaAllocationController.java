 ...
 */
@RestController
@RequestMapping("/api/allocation/woreda")
public class WoredaAllocationController {
    ...
    public AjaxResult page(@RequestParam(required = false) String allocationName,
        ...
        try {
            IPage<AllocationVO> page = allocationService.page(pageNum, pageSize, allocationName, year, zone, "woreda");
