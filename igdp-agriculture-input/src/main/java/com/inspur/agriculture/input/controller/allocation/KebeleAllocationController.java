 ...
 */
@RestController
@RequestMapping("/api/allocation/kebele")
public class KebeleAllocationController {
    ...
    public AjaxResult page(@RequestParam(required = false) String allocationName,
        ...
        try {
            IPage<AllocationVO> page = allocationService.page(pageNum, pageSize, allocationName, year, zone, "kebele");
